...
import com.carl_yang.uplibrary.callback.CancelClickListener;
import com.carl_yang.uplibrary.callback.CommitClickListener;
import com.carl_yang.uplibrary.callback.DownloadSuccessListener;
import com.carl_yang.uplibrary.callback.DownloadingListener;
...
public class VersionDialogActivity extends Activity {
    ...
    public void downloadFile(String url, FileCallback callback) {
        if (callback == null) {
            ...
            builder.setLargeIcon(getBitmap(versionParams.getbIcon()));
            builder.setSmallIcon(R.mipmap.icon_teachiing);
